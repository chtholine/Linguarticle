...
def crawl(request):
    ...
    if request.method == "POST":
        ...
        # This returns an ID which belongs and will belong to this task
        # We are going to use that to check task's status.
        task = scrapyd.schedule("default", "article_spider", settings=settings, url=url, domain=domain)
    ...
    # Get requests are for getting result of a specific crawling task
        ...
        if status == "finished":
            try:
                ...
                item = Article.objects.get(unique_id=unique_id)
